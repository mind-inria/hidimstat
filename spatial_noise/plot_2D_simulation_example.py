...
# generating the data
X_init, y, beta, noise = multivariate_simulation_spatial(
    n_samples,
    shape,
    roi_size=roi_size,
    sigma_noise=sigma,
...
beta_hat, sigma_hat, precision_diagonal = desparsified_lasso(X, y, n_jobs=n_jobs)
pval, pval_corr, one_minus_pval, one_minus_pval_corr, cb_min, cb_max = (
    desparsified_lasso_pvalue(X.shape[0], beta_hat, sigma_hat, precision_diagonal)
)
