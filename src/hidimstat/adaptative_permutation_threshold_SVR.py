import numpy as np
from hidimstat.statistical_tools.stat_tools import pval_from_scale
...
def ada_svr_pvalue(beta_hat, scale, distribution="norm", eps=1e-14):
    """
    ...
    """
    return pval_from_scale(beta_hat, scale, distribution=distribution, eps=eps)
