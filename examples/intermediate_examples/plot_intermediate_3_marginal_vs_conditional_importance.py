...
# Compute feature importance across the 5 folds, to derive the p-value computation.
for i, (train_index, test_index) in enumerate(kf.split(X)):
    ...
    permutation_importances.append(pfi.fit_importance(X_test, y_test))
...
# important, yielding invalid p-values when testing conditional importance.
