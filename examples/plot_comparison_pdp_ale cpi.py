...
**Accumulated Local Effects (ALE)** and **CPI method**
...
_ = pdp.plot(X_test, features=features)

# 2. ALE Plot
ale = ALE(model, feature_names=X.columns)
_ = ale.plot(X_test, features=features, grid_resolution=100)

# 3. CPI Plot
cpiplot = CPIPlot(model, feature_names=X.columns)
_ = cpiplot.plot(X_test, features=features, grid_resolution=100)
