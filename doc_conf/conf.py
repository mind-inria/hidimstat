...
if LooseVersion(sphinx_gallery.__version__) < LooseVersion("0.2"):
    raise ImportError(
        "Must have at least version 0.2 of sphinx-gallery, got "
...
from hidimstat import __version__  # noqa
...
man_pages = [(master_doc, "hidimstat", "Hidimstat Documentation", [author], 1)]
