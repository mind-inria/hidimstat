...
- :bdg-warning:`API` column names are properly handled when a pandas DataFrame is given as input, grouping can be done on column names (:gh:`721` by `Marc Hukcelle`_).
